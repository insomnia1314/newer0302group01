												...
												<td>
													<table align=center class="TABLE_STYLE4">
														<tr height=20 class="TR_STYLE1">
															...
															<a href="#" class="easyui-linkbutton" iconCls="icon-edit"
																plain="true" onclick="yanzhen()">提交</a>
															<input type="hidden" value="${pro.designId}"
																id="designId">
														</tr>
													</table>
													<table align=center class="TABLE_STYLE4">
													...
													<table bordercolor=#000000 bordercolorlight=#848284
														...
														<tr height=20 class="TR_STYLE1">
															...
															<td bordercolor=#DEDBD6 align=left class="TD_STYLE2">
																<a
																href="findByProductId.do?productId=${pro.productId }&&detailsNumber=${str.detailsNumber}&&productName=${pro.productName}&&designId=${pro.designId}&&procedureId=${str.prcedureId}&&procedureName=${str.procedureName }">
																	设计 </a>
															</td>
														</tr>
														</c:forEach>
