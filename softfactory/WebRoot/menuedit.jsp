...
.btn {
		...
		<form action="" method="post" id="menuForm">
			<table width="500" height="198" id="menuTable"
				...
				<tr>
					...
					<td>
						<input class="input" name="linkUrl" value="${menu.linkUrl }" />
					</td>
					<td>
						&nbsp;
					</td>
				...
				<tr>
					...
					<td>
						<input class="input" name="seq" value="${menu.seq }" />
					</td>
					<td>
						&nbsp;
					</td>
	...
	$("#menuSelect").combotree( {
		url : "menuController_indexAllEdit.do",
		width : 200,
	...
	$("#menuSelect").combotree("setValue", "${empty menu.parentId?'无父级菜单': parentMenu.name}");
				...
				<tr>
					...
					<td>
						<input class="input" name="descn" value="${menu.descn }" />
					</td>
					<td>
						&nbsp;
					</td>
