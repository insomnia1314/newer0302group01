...
<html>
	<head>
		...
		function change(){
			...
			$("#Verify").attr("src","${pageContext.request.contextPath}/imagecode.do?timestamp="+timestamp);			
		}
		...
		<DIV id=div1 style="padding-top:37px;">
			...
			<TABLE id=login height="100%" cellSpacing=0 cellPadding=0 width=800
				...
				<TBODY>
					<TR id=main>
						<TD>
							<form action="userController_login.do" method="post">
									...
									<TBODY>
										...
										<TR height=40>
											...
											<TD colspan="2" valign="middle">
												...
												<img align="top" onclick="change()" src="${pageContext.request.contextPath}/imagecode.do" id="Verify"  style="cursor:pointer; height:20px; width: 80px;" alt="看不清，换一张" title="看不清，换一张"/> 
											</TD>
										</TR>
										<TR height=40>
											<TD>&nbsp;</TD>
