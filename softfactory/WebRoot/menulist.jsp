...
<html>
	...
	$(function() {
		menu_obj = {
			...
			showEdit : function(state){
				var url = "menuController_findById.do";
				var info = "";
				var id = 0;
				if(state == 'add') {//新增
					info = "新增菜单信息";
		...
		$("#parentMenuSelect").combotree({
			url : "menuController_indexAllSearch.do",
			width : 200,
	...
	function getMenu(menuId){
		$("#editMenu").window({
			...
			modal : true,
			minimizable : false,
			href : "menuController_view.do?id="+menuId
		});
	}
</script>
	</body>
